/*
 * @Description: 从携程网提取出来的部分函数，用于生成Token
 * @Author: Senkita
 * @Date: 2020-10-22 15:19:26
 * @LastEditors: Senkita
 * @LastEditTime: 2020-10-22 16:21:34
 */
function a(e, t) {
...
function g(e, t = undefined, n = undefined) {
    return t ? n ? y(t, e) : p(y(t, e)) : n ? m(e) : p(m(e))
}

const getProductToken = function (e, t, n) {
    return g(e + t + n + "duew&^%5d54nc'KH")
}
